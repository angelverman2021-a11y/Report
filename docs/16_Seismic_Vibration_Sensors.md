...
> **Target File:** `docs/16_Seismic_Vibration_Sensors.md`
...
| **$T_6$** | 20 | **340** | **12,500** | **68.0** | **0.48** | 🔴 **CRITICAL COLLAPSE IMMINENT** |
...
graph TD
    subgraph Explainable Alert Notification Card
        A["🔴 LEVEL 4: CRITICAL ROCKFALL ALERT (Risk Probability: 97.6%)"]
        B["📍 Location: Bench 3 - North Highwall Sector (Geophone Array GEO-02 / CAM-01)"]
        C["⏱️ Predicted Dynamic Collapse Window: 11 ± 2 minutes"]
...
| **Displacement Prediction** | ❌ Blind to quasi-static creep | **Integrated:** Fused with 3D GNSS, InSAR, and sub-pixel optical flow |
