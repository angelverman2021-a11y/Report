...
> **Target File:** `docs/technologies/24_IoT_Sensor_Networks.md`
> **Technology Status:** [EXISTING] [PROTOTYPE] | 4-tier LoRaWAN mesh, MQTT v5.0 brokers, and InfluxDB time-series
