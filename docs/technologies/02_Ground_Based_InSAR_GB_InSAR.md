...
> **Target File:** `docs/technologies/02_Ground_Based_InSAR_GB_InSAR.md`
> **Technology Status:** [EXISTING] [RESEARCHED] | 2D Spatial deformation heatmapping concepts adopted; Hardware in Future Scope
