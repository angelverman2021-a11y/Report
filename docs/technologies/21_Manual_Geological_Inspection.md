...
> **Target File:** `docs/technologies/21_Manual_Geological_Inspection.md`
> **Technology Status:** [EXISTING] [PROTOTYPE] | Mobile field logging app for Human-in-the-Loop active learning
