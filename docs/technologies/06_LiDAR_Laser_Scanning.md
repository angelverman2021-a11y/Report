...
> **Target File:** `docs/technologies/06_LiDAR_Laser_Scanning.md`
> **Technology Status:** [EXISTING] [RESEARCHED] | CloudCompare M3C2 change detection algorithms adopted for scar analysis
