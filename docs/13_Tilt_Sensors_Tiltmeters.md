...
> **Target File:** `docs/13_Tilt_Sensors_Tiltmeters.md`
...
| **$T_6$** | 20 | +0.150 | +0.110 | 0.186 | **0.0390** | **+0.0111**| 🔴 **CRITICAL TOPPLING ACCELERATION** |
...
graph TD
    subgraph Explainable Alert Notification Card
        A["🔴 LEVEL 4: CRITICAL ROCKFALL ALERT (Risk Probability: 96.8%)"]
        B["📍 Location: Bench 4 - East Highwall Spur (Tiltmeter Node TLT-04 / CAM-02)"]
        C["⏱️ Predicted Toppling Window: 14 ± 3 minutes"]
